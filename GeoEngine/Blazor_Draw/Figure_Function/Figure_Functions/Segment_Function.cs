...
public class SegmentFunction : FigureFunction
{
    public Node P1 { get; set; }
    public Node P2 { get; set; }

    public SegmentFunction(Node p1, Node p2, int lineOfCode) : base(lineOfCode)
    {
        P1 = p1;
        P2 = p2;
    ...
    public override void Evaluate()
    {
        ...
        Value = new Segment((Point)P1.Value, (Point)P2.Value, LineOfCode);
    }
}